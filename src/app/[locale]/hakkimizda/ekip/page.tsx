...
const founders = [
  { name: "Ayşe Kaya", title: "Kurucu & CEO", bio: "Gıda teknolojisi ve sürdürülebilirlik alanında 8 yıl deneyim. Boğaziçi Üniversitesi İşletme mezunu. Daha önce gıda sektöründe iki girişim kurdu." },
  { name: "Mehmet Demir", title: "Kurucu & CTO", bio: "Ölçeklenebilir tüketici uygulamaları üzerine 10 yıl deneyim. ODTÜ Bilgisayar Mühendisliği. Daha önce iki startup'ı büyük şirketlere sattı." },
  { name: "Zeynep Arslan", title: "Kurucu & COO", bio: "Yerel işletmeler ve esnaf ekosistemiyle köklü ilişkiler. METU Gıda Mühendisliği mezunu. Sürdürülebilirlik ve tedarik zinciri uzmanı." },
  { name: "Can Yıldız", title: "Kurucu & CPO", bio: "Kullanıcı deneyimi odaklı ürün geliştirme. Bilkent Üniversitesi Endüstri Tasarımı. Daha önce büyük platformlarda UX lead rolü." },
];
...
const advisors = [
  { name: "Prof. Dr. Leyla Güneş", title: "Danışman — Gıda Güvenliği", bio: "İTÜ Gıda Mühendisliği Prof. Gıda israfı ve gıda güvenliği politikaları üzerine 20 yıl araştırma." },
  { name: "Hüseyin Öztürk", title: "Danışman — Girişim Ekosistemi", bio: "Istanbul Startup Studio kurucu ortağı. 40+ Türk girişimine melek yatırımcı." },
  { name: "Dr. Pınar Yılmaz", title: "Danışman — Sürdürülebilirlik & ESG", bio: "UNDP Türkiye eski danışmanı. SKH uygulaması ve iklim finansmanı uzmanı." },
];

export default function EkipPage() {
  const t = useTranslations("EkipPage");
    ...
    <>
      ...
      <section className="section-padding bg-cream">
        <div className="container-wide mx-auto">
          <SectionHeading label={t("founders.label")} title={t("founders.title")} />
      ...
      <section className="section-padding bg-cream-dark">
        <div className="container-wide mx-auto">
          <SectionHeading label={t("teamSection.label")} title={t("teamSection.title")} subtitle={t("teamSection.subtitle")} />
      ...
      <section className="section-padding bg-cream">
        <div className="container-wide mx-auto">
          <SectionHeading label={t("advisors.label")} title={t("advisors.title")} />
      ...
      <section className="section-padding bg-olive">
        <div className="container-wide mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-black text-white mb-3">{t("careerCta.title")}</h2>
          <p className="text-white/75 mb-6">{t("careerCta.desc")}</p>
